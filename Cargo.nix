  ...
  internal = rec {
    ...
    crates = {
      ...
      "clap" = rec {
        ...
        resolvedDefaultFeatures = [ "derive" "error-context" "help" "std" "usage" "wrap_help" ];
      };
      "clap_builder" = rec {
        ...
        resolvedDefaultFeatures = [ "error-context" "help" "std" "usage" "wrap_help" ];
      };
      "clap_derive" = rec {
        ...
        dependencies = [
          {
            ...
            packageId = "clap";
            usesDefaultFeatures = false;
            features = [ "derive" "error-context" "help" "std" "usage" "wrap_help" ];
          }
          {
            name = "color-eyre";
